  ...
  var $skinBlue =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-blue" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
            ...
            + '<div><span style="display:block; width: 20%; float: left; height: 20px; background: #272c33"></span><span style="display:block; width: 80%; float: left; height: 20px; background: #383f48"></span></div>'
            + '</a>'
  ...
  var $skinWhite =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-white" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
            + '<div style="box-shadow: 0 0 2px rgba(0,0,0,0.1)" class="clearfix"><span style="display:block; width: 20%; float: left; height: 7px; background: #cccccc"></span><span style="display:block; width: 80%; float: left; height: 7px; background: #ffffff"></span></div>'
            + '<div><span style="display:block; width: 20%; float: left; height: 20px; background: #272c33"></span><span style="display:block; width: 80%; float: left; height: 20px; background: #383f48"></span></div>'
            + '</a>'
            + '<p class="text-center no-margin">White</p>')
  $skinsList.append($skinWhite)
  var $skinPurple =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })

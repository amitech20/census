<?php
if (isset($_GET['view_by_lga'])) {
    $user_lga= htmlspecialchars($_GET['view_by_lga']);
}
//else, go back to previous page using js
else{
      ...
      <div class="col-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Enumerations at <?=get_lga($user_lga)?> LGA</h3>
          ...
          <div class="box-body">
            <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive" cellspacing="0" width="100%">
              ...
              <?php echo getCitizens("all","admin",$user_lga)?>
          </table>
